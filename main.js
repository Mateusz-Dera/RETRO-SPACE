...
// RETRO-SPACE
// Copyright © 2017-2019 Mateusz Dera

// This file is part of RETRO-SPACE.

// RETRO-SPACE is free software: you can redistribute it and/or modify
// it under the terms of the GNU General Public License as published by
// the Free Software Foundation; either version 3 of the License, or
// (at your option) any later version.

// RETRO-SPACE is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU General Public License for more details.

// You should have received a copy of the GNU General Public License
// along with RETRO-SPACE.  If not, see <http://www.gnu.org/licenses/>. 
...
var player = "<img src='assets/images/ship.png' width=96px height=32px/>";
var position = 0;
...
var bullet = "<img src='assets/images/bullet.png' width=32px height=32px/>";
var asteroid = "<img src='assets/images/asteroid.png' width=32px height=32px/>";
var live = "<img src='assets/images/live.png' width=32px height=32px/>";
var bonus = "<img src='assets/images/coin.png' width=32px height=32px/>";
var none = "<img src='assets/images/null.png' width=32px height=32px/>";
...
function loop() {
    ...
    if (pause == false && end == false) {
        ...
        if (death == false) {
            ...
            for (var i = 0; i != number_of_asteroids; i++)
                if (asteroids[i].x == position || asteroids[i].x == position + 1 || asteroids[i].x == position + 2)
                    if (asteroids[i].y == 16) {
                        ...
                        snd = new Audio("assets/sounds/live.wav");
                        ...
                        if (asteroids[i].type == 6) {
                            ...
                            if (asteroids[i].type == 4) {
                                score += 200;
                                snd = new Audio("assets/sounds/bonus.wav");
                            }
                            else {
                                ...
                                if (next_time == 0) {
                                    lives--;
                                    if (lives > 0)
                                        snd = new Audio("assets/sounds/crash.wav");
                                    else
                                        snd = new Audio("assets/sounds/death.wav");
            ...
            for (var l = 0; l != 18; l++) {
                ...
                if (l == 9) {
                    if (enter == true) {
                        ...
                        line = "<table><tr><td><font size=20px>Press <font color=#dd0070>ENTER</font></font><br><br><font>Control<font color=#abdf32> ARROWS</font><br>&nbsp;&nbsp;Shot <font color=#abdf32>SPACE</font><br>Pause<font color=#abdf32> P&nbsp;&nbsp;&nbsp;</font></font></font></td></tr></table>";
                }
            ...
            for (var j = 0; j != number_of_bullets; j++)
                for (var i = 0; i != number_of_asteroids; i++)
                    if (asteroids[i].x == bullets[j].x && (asteroids[i].y == bullets[j].y || asteroids[i].y == bullets[j].y + 1)) {
                        snd = new Audio("assets/sounds/explosion.wav");
            ...
            document.getElementById("info").innerHTML = "&nbsp;<font color=#dd0070>♥</font>" + lives + "&nbsp;&nbsp;&nbsp;<font color=#dd0070>Score</font>:<font color=#abdf32>" + score + "</font>";
        }
        else {
            ...
            document.getElementById(9).innerHTML = "<table><tr><td>GAME OVER<font color=#dd0070>!</td></tr></table>";
            end = true;
        }
    }
